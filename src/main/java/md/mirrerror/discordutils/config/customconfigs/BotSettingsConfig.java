...
public class BotSettingsConfig extends CustomConfig {
    ...
    public void initializeFields() {
        ...
        getFileConfiguration().addDefault("Roles.RolesToGroups", new HashMap<>());
        ...
        getFileConfiguration().addDefault("RolesSynchronization.AssignGroupsOnlyByPrimaryRole", true);
