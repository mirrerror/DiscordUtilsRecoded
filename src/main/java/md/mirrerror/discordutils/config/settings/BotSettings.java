...
public class BotSettings {
    ...
    public final Color SERVER_ACTIVITY_LOGGING_QUIT_EMBED_COLOR = Color.decode(config.getString("ServerActivityLogging.QuitEmbedColor"));
    public final Color SERVER_ACTIVITY_LOGGING_DEATH_EMBED_COLOR = Color.decode(config.getString("ServerActivityLogging.DeathEmbedColor"));
    public final Color SERVER_ACTIVITY_LOGGING_CHAT_EMBED_COLOR = Color.decode(config.getString("ServerActivityLogging.ChatEmbedColor"));
