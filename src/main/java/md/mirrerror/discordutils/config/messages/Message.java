...
public enum Message {
    ...
    USER_SUCCESSFULLY_MENTIONED(false),
    ...
    SECONDFACTOR_DISABLING_IS_NOT_AVAILABLE(false),
    ONLINE(false),
    ...
    MENTION_SLASH_COMMAND_DESCRIPTION(false),
    MENTION_SLASH_COMMAND_FIRST_ARGUMENT_NAME(false),
    MENTION_SLASH_COMMAND_FIRST_ARGUMENT_DESCRIPTION(false),
